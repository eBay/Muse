...
class DelegatedModule extends Module {
  constructor(sourceRequest, data, type, userRequest, originalRequest, museModuleId) {
    ...
    this.museModuleId = museModuleId;
  ...
  codeGeneration({ runtimeTemplate, moduleGraph, chunkGraph }) {
    ...
    let str;
    console.log('code gen', this.museModuleId);
    // if (!sourceModule) {
    //   console.log(this.sourceRequest);
    //   str = runtimeTemplate.throwMissingModuleErrorBlock({
    //     request: this.sourceRequest,
    //   });
    // } else {
    str = `module.exports = ${RuntimeGlobals.global}.__muse_shared_modules__.find('${this.museModuleId}');`;
    // str = 'module.exports = () => {}';
    // }
    // if (!sourceModule) {
    //   str = runtimeTemplate.throwMissingModuleErrorBlock({
