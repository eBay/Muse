...
(async () => {
  try {
    ...
    Object.assign(pkgJson.scripts, {
      ...
      build:
        'muse-cra-patch && craco build && cross-env NODE_ENV=development MUSE_DEV_BUILD=true FAST_REFRESH=false craco build ',
      'build:dist': 'muse-cra-patch && craco build',
      'build:dev':
        'muse-cra-patch && cross-env NODE_ENV=development MUSE_DEV_BUILD=true FAST_REFRESH=false craco build',
      'build:test':
